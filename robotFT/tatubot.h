...
class Robot {
  ...
  public:
    ...
    void girarALaDerechaBailando();
    void girarALaIzquierdaBailando();
    void bailar(int velocidad, int giroDerecha, int giroIzquierda);
    void girarALaDerechaParaBailar(int giroALaDerecha);
    void girarALaIzquierdaParaBailar(int giroALaIzquierda);
    void moverHaciaAdelanteParaBailar(int velocidad);
    void moverHaciaAtrasParaBailar(int velocidad);
